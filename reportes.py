...
def actualizar_programa():
    try:
        ...
        # Script .bat con 20 segundos de espera para PCs de oficina lentas
        ...
        messagebox.showinfo("Éxito", "Descarga finalizada. El proceso tardará 20 segundos.")
...
def generar_reportes():
    ...
    try: # Bloque try completo con su except y finally
